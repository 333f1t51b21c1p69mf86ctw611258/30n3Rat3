/* Formatted on 12/28/2014 2:14:28 PM (QP5 v5.215.12089.38647) */
--DELETE SUBSCRIBER WHERE 1 = 1;
--DELETE ACCOUNT WHERE 1 = 1;
--DELETE ACCOUNT_VERSION WHERE 1 = 1;
--DELETE SUBS_OFFER_MAP WHERE 1 = 1;
...
SELECT ACCOUNT_VERSION_ID,
 ...
 WHERE subscriber_no = 84913215885;
...
SELECT ACCOUNT_VERSION_ID,
 ...
 WHERE ACCOUNT_VERSION_ID = 684430;

SELECT *
  FROM AUDIT_SEGMENT_SELECT
 WHERE ACCOUNT_VERSION_ID = 684430;
...
-- product
  ...
  SELECT ACCOUNT_VERSION_ID,
   ...
   WHERE ACCOUNT_VERSION_ID = 684430 AND PRODUCT_OFFER.RESELLER_VERSION_ID = 8
ORDER BY DECODE (PRODUCT_OFFER.OFFER_TYPE,  'PO', 1,  'SO', 2,  3);

SELECT *
  FROM PRODUCT_SELECT
 WHERE subscriber_no = 84913215885 AND reseller_version_id = 8;
