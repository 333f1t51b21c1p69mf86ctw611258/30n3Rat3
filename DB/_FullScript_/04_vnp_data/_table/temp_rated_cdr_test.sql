DROP TABLE VNP_DATA.TEMP_RATED_CDR_TEST CASCADE CONSTRAINTS;

CREATE TABLE VNP_DATA.TEMP_RATED_CDR_TEST
(
...
GRANT DELETE, INSERT, SELECT, UPDATE ON VNP_DATA.TEMP_RATED_CDR_TEST TO VNP_COMMON;

GRANT SELECT ON VNP_DATA.TEMP_RATED_CDR_TEST TO VNP_VIEW;
