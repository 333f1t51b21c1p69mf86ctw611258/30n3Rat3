...
CREATE TABLESPACE hot_rated_tmp1_p0
  DATAFILE '+DATA/eonerate/datafile/vnp_data/hot_rated_tmp1_p0.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_tmp1_p1
  DATAFILE '+DATA/eonerate/datafile/vnp_data/hot_rated_tmp1_p1.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_tmp1_p2
  DATAFILE '+DATA/eonerate/datafile/vnp_data/hot_rated_tmp1_p2.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_tmp1_p3
  DATAFILE '+DATA/eonerate/datafile/vnp_data/hot_rated_tmp1_p3.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_tmp1_p4
  DATAFILE '+DATA/eonerate/datafile/vnp_data/hot_rated_tmp1_p4.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_tmp1_p5
  DATAFILE '+DATA/eonerate/datafile/vnp_data/hot_rated_tmp1_p5.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_tmp1_p6
  DATAFILE '+DATA/eonerate/datafile/vnp_data/hot_rated_tmp1_p6.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_tmp1_p7
  DATAFILE '+DATA/eonerate/datafile/vnp_data/hot_rated_tmp1_p7.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_tmp1_p8
  DATAFILE '+DATA/eonerate/datafile/vnp_data/hot_rated_tmp1_p8.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_tmp1_p9
  DATAFILE '+DATA/eonerate/datafile/vnp_data/hot_rated_tmp1_p9.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;
...
PARTITION BY RANGE (DATA_PART)
   (PARTITION P0 VALUES LESS THAN (1)
       TABLESPACE hot_rated_tmp1_p0,
    PARTITION P1 VALUES LESS THAN (2)
       TABLESPACE hot_rated_tmp1_p1,
    PARTITION P2 VALUES LESS THAN (3)
       TABLESPACE hot_rated_tmp1_p2,
    PARTITION P3 VALUES LESS THAN (4)
       TABLESPACE hot_rated_tmp1_p3,
    PARTITION P4 VALUES LESS THAN (5)
       TABLESPACE hot_rated_tmp1_p4,
    PARTITION P5 VALUES LESS THAN (6)
       TABLESPACE hot_rated_tmp1_p5,
    PARTITION P6 VALUES LESS THAN (7)
       TABLESPACE hot_rated_tmp1_p6,
    PARTITION P7 VALUES LESS THAN (8)
       TABLESPACE hot_rated_tmp1_p7,
    PARTITION P8 VALUES LESS THAN (9)
       TABLESPACE hot_rated_tmp1_p8,
    PARTITION P9 VALUES LESS THAN (10)
       TABLESPACE hot_rated_tmp1_p9);

CREATE INDEX IDX_hrc_tmp1_A_NUMBER
   ON HOT_RATED_CDR_temp1 (A_NUMBER)
   TABLESPACE VNP_DATA_HRC;


CREATE INDEX IDX_hrc_tmp1_CDR_REC_HEAD_ID
   ON HOT_RATED_CDR_temp1 (CDR_RECORD_HEADER_ID)
   TABLESPACE VNP_DATA_HRC;

CREATE INDEX IDX_hrc_tmp1_CREATED_TIME
