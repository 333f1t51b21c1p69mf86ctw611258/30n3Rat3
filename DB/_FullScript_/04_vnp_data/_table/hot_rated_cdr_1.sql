/* Formatted on 16/3/15 12:53:15 (QP5 v5.240.12305.39476) */
DROP TABLE VNP_DATA.HOT_RATED_CDR_1;

SELECT file_name FROM dba_data_files;

DROP TABLESPACE hot_rated_1_p0
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE hot_rated_1_p0
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_1_p0.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;

DROP TABLESPACE hot_rated_1_p1
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE hot_rated_1_p1
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_1_p1.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;

DROP TABLESPACE hot_rated_1_p2
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE hot_rated_1_p2
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_1_p2.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;

DROP TABLESPACE hot_rated_1_p3
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE hot_rated_1_p3
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_1_p3.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;

DROP TABLESPACE hot_rated_1_p4
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE hot_rated_1_p4
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_1_p4.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;

DROP TABLESPACE hot_rated_1_p5
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE hot_rated_1_p5
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_1_p5.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;

DROP TABLESPACE hot_rated_1_p6
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE hot_rated_1_p6
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_1_p6.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;

DROP TABLESPACE hot_rated_1_p7
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE hot_rated_1_p7
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_1_p7.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;

DROP TABLESPACE hot_rated_1_p8
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE hot_rated_1_p8
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_1_p8.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;

DROP TABLESPACE hot_rated_1_p9
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE hot_rated_1_p9
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_1_p9.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;
...
PARTITION BY RANGE (DATA_PART)
   (PARTITION P0 VALUES LESS THAN (1)
       TABLESPACE hot_rated_1_p0,
    PARTITION P1 VALUES LESS THAN (2)
       TABLESPACE hot_rated_1_p1,
    PARTITION P2 VALUES LESS THAN (3)
       TABLESPACE hot_rated_1_p2,
    PARTITION P3 VALUES LESS THAN (4)
       TABLESPACE hot_rated_1_p3,
    PARTITION P4 VALUES LESS THAN (5)
       TABLESPACE hot_rated_1_p4,
    PARTITION P5 VALUES LESS THAN (6)
       TABLESPACE hot_rated_1_p5,
    PARTITION P6 VALUES LESS THAN (7)
       TABLESPACE hot_rated_1_p6,
    PARTITION P7 VALUES LESS THAN (8)
       TABLESPACE hot_rated_1_p7,
    PARTITION P8 VALUES LESS THAN (9)
       TABLESPACE hot_rated_1_p8,
    PARTITION P9 VALUES LESS THAN (10)
       TABLESPACE hot_rated_1_p9);

DROP TABLESPACE vnp_data_HRC_1_A_NUMBER
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE vnp_data_HRC_1_A_NUMBER
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/HRC_1_A_NUMBER01.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;
...
CREATE INDEX IDX_HRC_1_A_NUMBER
   ...
   TABLESPACE vnp_data_HRC_1_A_NUMBER;

DROP TABLESPACE vnp_data_hrc_1_rec_head_id
  INCLUDING CONTENTS AND DATAFILES
    CASCADE CONSTRAINTS;

CREATE TABLESPACE vnp_data_hrc_1_rec_head_id
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hrc_1_rec_head_id01.dbf'
    SIZE 10M
    REUSE
    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;
...
--DROP TABLESPACE vnp_data_hrc_1_created_time
--  INCLUDING CONTENTS AND DATAFILES
--    CASCADE CONSTRAINTS;
--
--CREATE TABLESPACE vnp_data_hrc_1_created_time
--  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hrc_1_created_time01.dbf'
--    SIZE 10M
--    REUSE
--    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;
--
--DROP INDEX IDX_HRC_1_CREATED_TIME;
...
--  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hrc_1_rerate_flag01.dbf'
--    SIZE 10M
--    REUSE
--    AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED;
--
