...
CREATE TABLESPACE hot_rated_3_p0
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_3_p0.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_3_p1
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_3_p1.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_3_p2
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_3_p2.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_3_p3
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_3_p3.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_3_p4
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_3_p4.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_3_p5
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_3_p5.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_3_p6
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_3_p6.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_3_p7
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_3_p7.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_3_p8
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_3_p8.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_rated_3_p9
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hot_rated_3_p9.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;
...
CREATE TABLESPACE vnp_data_HRC_3_A_NUMBER
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/HRC_3_A_NUMBER01.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

DROP INDEX IDX_HRC_3_A_NUMBER;

CREATE INDEX IDX_HRC_3_A_NUMBER
   ON HOT_RATED_CDR_3 (A_NUMBER)
   TABLESPACE VNP_DATA_HRC;


CREATE TABLESPACE vnp_data_hrc_3_rec_head_id
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hrc_3_rec_head_id01.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;
...
CREATE TABLESPACE vnp_data_hrc_3_created_time
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hrc_3_created_time01.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;
...
--  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/hrc_3_rerate_flag01.dbf'
--    SIZE 100M
--    REUSE
--    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;
--
