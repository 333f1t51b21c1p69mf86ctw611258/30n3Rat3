DROP TABLE VNP_DATA.TEMP_RATED_CDR_2 CASCADE CONSTRAINTS;

CREATE TABLESPACE vnp_DATA_TRC_2
  DATAFILE '/cdr/u01/app/oracle/oradata/eonerate/vnp_data/temp_rated_cdr_201.dbf'
    SIZE 100M
    REUSE
    AUTOEXTEND ON NEXT 100 M MAXSIZE UNLIMITED;

CREATE TABLE VNP_DATA.TEMP_RATED_CDR_2
(
...
GRANT DELETE, INSERT, SELECT, UPDATE ON VNP_DATA.TEMP_RATED_CDR_2 TO VNP_COMMON;

GRANT SELECT ON VNP_DATA.TEMP_RATED_CDR_2 TO VNP_VIEW;
