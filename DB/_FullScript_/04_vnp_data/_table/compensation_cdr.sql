DROP TABLE VNP_DATA.COMPENSATION_CDR CASCADE CONSTRAINTS;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON VNP_DATA.COMPENSATION_CDR TO VNP_COMMON;

GRANT SELECT ON VNP_DATA.COMPENSATION_CDR TO VNP_VIEW;
