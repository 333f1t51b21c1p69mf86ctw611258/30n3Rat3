...
CREATE TABLESPACE vnp_data_hot_aggregated
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_aggregated01.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_aggregated_p0
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_aggregated_p0.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_aggregated_p1
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_aggregated_p1.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_aggregated_p2
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_aggregated_p2.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_aggregated_p3
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_aggregated_p3.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_aggregated_p4
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_aggregated_p4.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_aggregated_p5
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_aggregated_p5.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_aggregated_p6
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_aggregated_p6.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_aggregated_p7
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_aggregated_p7.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_aggregated_p8
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_aggregated_p8.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;

CREATE TABLESPACE hot_aggregated_p9
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hot_aggregated_p9.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;
...
CREATE TABLESPACE vnp_data_hac_some1
  DATAFILE '/u01/app/oracle/oradata/eonerate/vnp_data/hac_some101.dbf'
    SIZE 50M
    REUSE
    AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED;
