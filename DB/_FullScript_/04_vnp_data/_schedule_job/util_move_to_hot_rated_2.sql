...
BEGIN
   SYS.DBMS_SCHEDULER.DROP_JOB (job_name => 'VNP_DATA.UTIL_MOVE_TO_HOT_RATED_2');
END;
/
...
BEGIN
   SYS.DBMS_SCHEDULER.CREATE_JOB (
      ...
      job_action        => 'BEGIN VNP_DATA.STUFF.MOVE_TO_HOT_RATED_2; END;',
      comments          => 'MOVE DATA FROM HRC_1, 2 TO HRC');
   SYS.DBMS_SCHEDULER.SET_ATTRIBUTE (
      name        => 'VNP_DATA.UTIL_MOVE_TO_HOT_RATED_2',
   ...
   SYS.DBMS_SCHEDULER.ENABLE (name => 'VNP_DATA.UTIL_MOVE_TO_HOT_RATED_2');
END;
/