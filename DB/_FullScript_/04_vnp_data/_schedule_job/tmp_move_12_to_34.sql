...
BEGIN
   SYS.DBMS_SCHEDULER.DROP_JOB (job_name => 'VNP_DATA.tmp_move_12_to_34');
END;
/

BEGIN
   SYS.DBMS_SCHEDULER.CREATE_JOB (
      job_name          => 'VNP_DATA.tmp_move_12_to_34',
   ...
   SYS.DBMS_SCHEDULER.SET_ATTRIBUTE (name        => 'VNP_DATA.tmp_move_12_to_34',
                                     attribute   => 'RESTARTABLE',
                                     VALUE       => FALSE);
   SYS.DBMS_SCHEDULER.SET_ATTRIBUTE (
      name        => 'VNP_DATA.tmp_move_12_to_34',
   ...
   SYS.DBMS_SCHEDULER.ENABLE (name => 'VNP_DATA.tmp_move_12_to_34');
END;
/