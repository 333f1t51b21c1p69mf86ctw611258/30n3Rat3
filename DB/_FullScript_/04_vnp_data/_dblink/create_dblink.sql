...
DROP DATABASE LINK VNP_RAC_VNP_DATA;

CREATE DATABASE LINK VNP_RAC_VNP_VIEW
 CONNECT TO vnp_view
 IDENTIFIED BY vnp_view
 USING 'VNP_RAC_EONERATE';

CREATE DATABASE LINK VNP_RAC_VNP_DATA
 CONNECT TO vnp_data
 IDENTIFIED BY vnp_data
 USING 'VNP_RAC_EONERATE';
 
DROP DATABASE LINK VNP_RAC_VNP_COMMON;

CREATE DATABASE LINK VNP_RAC_VNP_COMMON
