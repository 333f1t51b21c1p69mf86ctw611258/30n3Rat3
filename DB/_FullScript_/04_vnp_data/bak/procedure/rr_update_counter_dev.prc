DROP PROCEDURE VNP_DATA.RR_UPDATE_COUNTER_DEV;

CREATE OR REPLACE PROCEDURE VNP_DATA.RR_UPDATE_COUNTER_DEV (
...
BEGIN
   ...
   IF rowExist = 0
   THEN
      INSERT INTO BALANCE_COUNTER_DEV (BAL_GROUP_ID,
                                       COUNTER_ID,
                                       RECORD_ID,
                                       VALID_FROM,
                                       VALID_TO,
...
GRANT EXECUTE ON VNP_DATA.RR_UPDATE_COUNTER_DEV TO PCAT_FILTER;
