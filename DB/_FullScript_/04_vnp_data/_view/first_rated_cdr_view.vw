DROP VIEW VNP_DATA.FIRST_RATED_CDR_VIEW;

/* Formatted on 2/6/2015 11:44:54 AM (QP5 v5.269.14213.34746) */
CREATE OR REPLACE FORCE VIEW VNP_DATA.FIRST_RATED_CDR_VIEW
(
   TOTAL_CDR,
   A_NUMBER,
   BILL_MONTH,
...
AS
     SELECT /*+ PARALLEL(FIRST_TEMP_RATED_CDR, 4) */
       ...
       FROM vnp_data.first_temp_rated_cdr
   GROUP BY a_number,
            cdr_type,
            payment_item_id,
