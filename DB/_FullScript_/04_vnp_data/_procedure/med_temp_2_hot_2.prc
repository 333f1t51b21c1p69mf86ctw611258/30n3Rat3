DROP PROCEDURE VNP_DATA.MED_TEMP_2_HOT_2;

CREATE OR REPLACE PROCEDURE VNP_DATA.med_temp_2_hot_2 (
   IN_HEADER_ID   IN     VNP_DATA.TEMP_RATED_CDR_2.CDR_RECORD_HEADER_ID%TYPE,
...
******************************************************************************/
BEGIN
   INSERT /*+APPEND */ INTO VNP_DATA.HOT_RATED_CDR_2 NOLOGGING(
                                        MAP_ID,
                                        A_NUMBER,
                                       CDR_TYPE,
                                       CREATED_TIME,
