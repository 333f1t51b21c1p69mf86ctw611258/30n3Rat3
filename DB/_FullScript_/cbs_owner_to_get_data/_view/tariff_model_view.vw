DROP VIEW CBS_OWNER.TARIFF_MODEL_VIEW;

/* Formatted on 22/05/2014 15:08:20 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.TARIFF_MODEL_VIEW
(
   TARIFF_MODEL_ID,
   TARIFF_MODEL_NAME,
   RESELLER_VERSION_ID,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON CBS_OWNER.TARIFF_MODEL_VIEW TO VNP_COMMON;
