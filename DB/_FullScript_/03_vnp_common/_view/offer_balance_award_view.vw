...
/* Formatted on 18/11/2014 3:41:20 PM (QP5 v5.215.12089.38647) */
...
AS
   SELECT OFFER_RC_AWARD_MAP_ID,
          ...
          * 60
          ...
          DEFAULT_SET_FUNCTION,
          PO.IS_INTERNAL
     FROM OFFER_RC_AWARD_MAP oram, product_offer po
    WHERE     ORAM.OFFER_ID = PO.OFFER_ID
          AND ORAM.RESELLER_VERSION_ID = PO.RESELLER_VERSION_ID;
