ALTER TABLE VNP_COMMON.SFTP_FILE
 DROP PRIMARY KEY CASCADE;

DROP TABLE VNP_COMMON.SFTP_FILE CASCADE CONSTRAINTS;

CREATE TABLE VNP_COMMON.SFTP_FILE
(
...
CREATE UNIQUE INDEX VNP_COMMON.SFTP_FILE_PK ON VNP_COMMON.SFTP_FILE
(SFTP_FILE)
LOGGING
TABLESPACE VNP_COMMON
PCTFREE    10
