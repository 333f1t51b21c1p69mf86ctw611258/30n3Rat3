DROP VIEW ACCUMULATOR_VIEW;

/* Formatted on 28/12/2014 17:17:15 (QP5 v5.215.12089.38647) */
CREATE OR REPLACE FORCE VIEW ACCUMULATOR_VIEW
(
   ACCUMULATOR_ID,
   ACCUMULATOR_NAME,
   RESELLER_VERSION_ID,
...
GRANT SELECT ON ACCUMULATOR_VIEW TO VNP_COMMON;
