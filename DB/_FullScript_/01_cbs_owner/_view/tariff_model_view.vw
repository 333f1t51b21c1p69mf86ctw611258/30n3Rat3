DROP VIEW TARIFF_MODEL_VIEW;

/* Formatted on 28/12/2014 17:17:24 (QP5 v5.215.12089.38647) */
CREATE OR REPLACE FORCE VIEW TARIFF_MODEL_VIEW
(
   TARIFF_MODEL_ID,
   TARIFF_MODEL_NAME,
   RESELLER_VERSION_ID,
...
GRANT SELECT ON TARIFF_MODEL_VIEW TO VNP_COMMON;
