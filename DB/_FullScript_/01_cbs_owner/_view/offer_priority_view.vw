DROP VIEW OFFER_PRIORITY_VIEW;

/* Formatted on 28/12/2014 17:17:19 (QP5 v5.215.12089.38647) */
CREATE OR REPLACE FORCE VIEW OFFER_PRIORITY_VIEW
(
   OFFER_ID,
   OFFER_NAME,
...
GRANT SELECT ON OFFER_PRIORITY_VIEW TO VNP_COMMON;
