CREATE OR REPLACE VIEW OFFER_BALANCE_MAP_VIEW
(
   BALANCE_NAME,
   BALANCE_ID,
   OFFER_NAME,
...
AS
     SELECT t4.DISPLAY_VALUE AS balance_name,                   -- balanceKey,
            ...
            t1.LIMITED_CONSUMPTION_FLAG,
            t1.LIMITED_CONSUMPTION_AMOUNT,
...
COMMENT ON TABLE OFFER_BALANCE_MAP_VIEW IS '';

GRANT SELECT ON OFFER_BALANCE_MAP_VIEW TO VNP_COMMON;
