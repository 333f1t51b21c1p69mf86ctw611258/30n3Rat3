DROP VIEW DISCOUNT_MODEL_VIEW;

/* Formatted on 28/12/2014 17:17:18 (QP5 v5.215.12089.38647) */
CREATE OR REPLACE FORCE VIEW DISCOUNT_MODEL_VIEW
(
   DISCOUNT_ITEM_ID,
   DISCOUNT_ITEM_NAME,
   RESELLER_VERSION_ID,
...
GRANT SELECT ON DISCOUNT_MODEL_VIEW TO VNP_COMMON;
