...
/* Formatted on 28/12/2014 17:17:25 (QP5 v5.215.12089.38647) */
     ...
     FROM cbs_owner.TARIFF_PLAN_MAPPING t1
          ...
          LEFT OUTER JOIN cbs_owner.RATE_CURRENCY_VALUES t8
             ON     t6.DEFAULT_CURRENCY_CODE = t8.CURRENCY_CODE
                AND t8.SERVICE_VERSION_ID = t100.SERVICE_VERSION_ID
                AND t8.LANGUAGE_CODE = t4.LANGUAGE_CODE
          -- *** add calendar
          INNER JOIN cbs_owner.CALENDAR_REF t22
...
GRANT SELECT ON TARIFF_PLAN_VIEW TO VNP_COMMON;
