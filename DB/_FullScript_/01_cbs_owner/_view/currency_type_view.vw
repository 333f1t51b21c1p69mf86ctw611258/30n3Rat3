DROP VIEW CURRENCY_TYPE_VIEW;

/* Formatted on 28/12/2014 17:17:17 (QP5 v5.215.12089.38647) */
CREATE OR REPLACE FORCE VIEW CURRENCY_TYPE_VIEW
(
   CURRENCY_CODE,
   SERVICE_VERSION_ID,
   CURRENCY_NAME,
...
GRANT SELECT ON CURRENCY_TYPE_VIEW TO VNP_COMMON;
