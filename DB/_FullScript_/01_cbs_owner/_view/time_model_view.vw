DROP VIEW TIME_MODEL_VIEW;

/* Formatted on 28/12/2014 17:17:27 (QP5 v5.215.12089.38647) */
CREATE OR REPLACE FORCE VIEW TIME_MODEL_VIEW
(
   CALENDAR_ID,
   CALENDAR_NAME,
   MODEL_TYPE,
...
GRANT SELECT ON TIME_MODEL_VIEW TO VNP_COMMON;
