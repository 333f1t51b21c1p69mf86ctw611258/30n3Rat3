DROP VIEW CBS_OWNER.RUM_MAP_VIEW;

/* Formatted on 10/12/2014 9:03:02 AM (QP5 v5.215.12089.38647) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.RUM_MAP_VIEW
(
...
AS
   SELECT t61.TARIFF_PLAN_MAPPING_ID AS tariff_plan_mapping_id, -- tariffPlanMappingId,
     ...
     FROM cbs_owner.TARIFF_PLAN_MAPPING t61
          ...
          INNER JOIN cbs_owner.TARIFF_PLAN_REF t63
          ...
          INNER JOIN cbs_owner.RESELLER_VERSION T100
             ON t100.RESELLER_VERSION_ID = t63.RESELLER_VERSION_ID
          INNER JOIN cbs_owner.TARIFF_PLAN_VALUES t64
          ...
          INNER JOIN cbs_owner.RATE_CURRENCY_VALUES t68
             ON     t3.DEFAULT_CURRENCY_CODE = t68.CURRENCY_CODE
                AND t68.SERVICE_VERSION_ID = t100.SERVICE_VERSION_ID
          ...
          INNER JOIN cbs_owner.UNITS_TYPE_REF t21
             ON     t20.UNIT_TYPE = t21.UNIT_TYPE
                AND t21.SERVICE_VERSION_ID = t100.SERVICE_VERSION_ID
          ...
          -- *** add currency
          INNER JOIN cbs_owner.RATE_CURRENCY_REF t42
             ON     t6.CURRENCY_CODE = t42.CURRENCY_CODE
                AND t42.SERVICE_VERSION_ID = t21.SERVICE_VERSION_ID
          INNER JOIN cbs_owner.RATE_CURRENCY_VALUES t43
...
GRANT SELECT ON CBS_OWNER.RUM_MAP_VIEW TO VNP_COMMON;
