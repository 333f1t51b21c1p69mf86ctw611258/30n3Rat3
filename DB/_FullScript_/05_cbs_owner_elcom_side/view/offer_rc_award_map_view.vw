DROP VIEW CBS_OWNER.OFFER_RC_AWARD_MAP_VIEW;

/* Formatted on 10/12/2014 9:02:57 AM (QP5 v5.215.12089.38647) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.OFFER_RC_AWARD_MAP_VIEW
(
...
AS
   SELECT t1.OFFER_RC_AWARD_MAP_ID AS offer_rc_award_map_id, -- offerRcAwardMapId,
          ...
          T100.SERVICE_VERSION_ID, -- t14.SERVICE_VERSION_ID AS serviceVersionId,
     ...
     FROM cbs_owner.OFFER_RC_AWARD_MAP t1
          ...
          LEFT OUTER JOIN cbs_owner.RATE_CURRENCY_REF t14
             ON     t13.CURRENCY_CODE = t14.CURRENCY_CODE
                AND t14.SERVICE_VERSION_ID = t100.SERVICE_VERSION_ID
          LEFT OUTER JOIN cbs_owner.RATE_CURRENCY_VALUES t15
             ON     t13.CURRENCY_CODE = t15.CURRENCY_CODE
                AND t15.SERVICE_VERSION_ID = t100.SERVICE_VERSION_ID
          ...
          LEFT OUTER JOIN cbs_owner.GUI_INDICATOR_REF t23
          ...
          LEFT OUTER JOIN cbs_owner.GUI_INDICATOR_VALUES t24
          ...
          LEFT OUTER JOIN cbs_owner.GUI_INDICATOR_REF t27
          ...
          LEFT OUTER JOIN cbs_owner.GUI_INDICATOR_VALUES t28
          ...
          LEFT OUTER JOIN cbs_owner.GENERIC_ENUMERATION_REF t29
             ON     t29.enumeration_key = LOWER ('ROLLOVER_GROUPING')
                AND t29.VALUE = t1.ROLLOVER_GROUPING
          LEFT OUTER JOIN cbs_owner.GENERIC_ENUMERATION_VALUES t30
