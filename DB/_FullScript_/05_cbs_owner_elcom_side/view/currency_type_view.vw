DROP VIEW CBS_OWNER.CURRENCY_TYPE_VIEW;

/* Formatted on 10/12/2014 9:02:53 AM (QP5 v5.215.12089.38647) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.CURRENCY_TYPE_VIEW
(
   CURRENCY_CODE,
   SERVICE_VERSION_ID,
   CURRENCY_NAME,
...
GRANT SELECT ON CBS_OWNER.CURRENCY_TYPE_VIEW TO VNP_COMMON;
