DROP VIEW CBS_OWNER.DISCOUNT_MODEL_VIEW;

/* Formatted on 10/12/2014 9:02:54 AM (QP5 v5.215.12089.38647) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.DISCOUNT_MODEL_VIEW
(
   DISCOUNT_ITEM_ID,
   DISCOUNT_ITEM_NAME,
   RESELLER_VERSION_ID,
   ...
   SELECT t41.DISCOUNT_ITEM_ID AS discount_item_id,         -- discountItemId,
     ...
     FROM cbs_owner.RT_DISCOUNT_ITEM_KEY t41
          ...
          INNER JOIN cbs_owner.RESELLER_VERSION T100
             ON t100.RESELLER_VERSION_ID = t43.RESELLER_VERSION_ID
          -- {{{ add discount
          ...
          LEFT OUTER JOIN cbs_owner.RATE_CURRENCY_REF t10
             ON     t9.CURRENCY_CODE = t10.CURRENCY_CODE
                AND t10.SERVICE_VERSION_ID = t100.SERVICE_VERSION_ID
          LEFT OUTER JOIN cbs_owner.RATE_CURRENCY_VALUES t11
             ON     t9.CURRENCY_CODE = t11.CURRENCY_CODE
                AND t11.SERVICE_VERSION_ID = t100.SERVICE_VERSION_ID
          ...
          LEFT OUTER JOIN cbs_owner.RATE_CURRENCY_REF t70
             ON     t69.currency_code = t70.currency_code
                AND t70.service_version_id = t100.SERVICE_VERSION_ID
...
GRANT SELECT ON CBS_OWNER.DISCOUNT_MODEL_VIEW TO VNP_COMMON;
