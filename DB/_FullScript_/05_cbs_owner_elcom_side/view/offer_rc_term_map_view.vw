DROP VIEW CBS_OWNER.OFFER_RC_TERM_MAP_VIEW;

/* Formatted on 10/12/2014 9:02:58 AM (QP5 v5.215.12089.38647) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.OFFER_RC_TERM_MAP_VIEW
(
   OFFER_NAME,
   OFFER_ID,
   RC_TERM_NAME,
...
AS
   SELECT t4.DISPLAY_VALUE AS offer_name,                         -- offerKey,
     ...
     FROM cbs_owner.OFFER_RC_TERM_MAP t1
          ...
          LEFT OUTER JOIN cbs_owner.GUI_INDICATOR_REF t8
          ...
          LEFT OUTER JOIN cbs_owner.GUI_INDICATOR_VALUES t9
          ...
          LEFT OUTER JOIN cbs_owner.BILL_PERIOD_VALUES t11
          ...
          LEFT OUTER JOIN cbs_owner.BILLING_FREQUENCY_VALUES t13
...
GRANT SELECT ON CBS_OWNER.OFFER_RC_TERM_MAP_VIEW TO VNP_COMMON;
