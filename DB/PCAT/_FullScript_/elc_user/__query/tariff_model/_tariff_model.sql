/* Formatted on 3/24/2014 11:18:09 AM (QP5 v5.215.12089.38647) */
--CREATE TABLE tariff_model
--AS

SELECT t1.TARIFF_ID AS tariff_id,                                 -- tariffId,
       t3.DISPLAY_VALUE AS tariff_name,                       -- displayValue,
       ...
       t8.ISO_CODE AS currency_iso_code,                   -- currencyIsoCode,
       --       t8.IMPLIED_DECIMAL AS currencyImpliedDecimal,
       t9.DISPLAY_VALUE AS rate_currency_key,              -- rateCurrencyKey,
       t2.CURRENCY_CODE AS currency_code,                     -- currencyCode,
       -- *** add and modify
       1 AS STEP,
       0 AS TIER_FROM,
