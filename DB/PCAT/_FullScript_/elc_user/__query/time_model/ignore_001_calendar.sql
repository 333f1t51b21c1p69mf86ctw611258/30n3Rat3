/* Formatted on 3/19/2014 11:12:25 PM (QP5 v5.227.12220.39754) */
SELECT t1.CALENDAR_ID AS calendarId,
  ...
  FROM CALENDAR_KEY t1
       ...
       INNER JOIN DAY_TYPE_ID_KEY t12 ON t2.WEDNESDAY_ID = t12.DAY_TYPE_ID
       INNER JOIN
       DAY_TYPE_ID_REF t13
          ON     t12.DAY_TYPE_ID = t13.DAY_TYPE_ID
             AND t13.RESELLER_VERSION_ID = t2.RESELLER_VERSION_ID
       INNER JOIN
       DAY_TYPE_ID_VALUES t14
       ...
       INNER JOIN DAY_TYPE_ID_KEY t15 ON t2.THURSDAY_ID = t15.DAY_TYPE_ID
       INNER JOIN
       DAY_TYPE_ID_REF t16
          ON     t15.DAY_TYPE_ID = t16.DAY_TYPE_ID
             AND t16.RESELLER_VERSION_ID = t2.RESELLER_VERSION_ID
       INNER JOIN
       DAY_TYPE_ID_VALUES t17
       ...
       INNER JOIN DAY_TYPE_ID_KEY t18 ON t2.FRIDAY_ID = t18.DAY_TYPE_ID
       INNER JOIN
       DAY_TYPE_ID_REF t19
          ON     t18.DAY_TYPE_ID = t19.DAY_TYPE_ID
             AND t19.RESELLER_VERSION_ID = t2.RESELLER_VERSION_ID
       INNER JOIN
       DAY_TYPE_ID_VALUES t20
       ...
       INNER JOIN DAY_TYPE_ID_KEY t21 ON t2.SATURDAY_ID = t21.DAY_TYPE_ID
       INNER JOIN
       DAY_TYPE_ID_REF t22
          ON     t21.DAY_TYPE_ID = t22.DAY_TYPE_ID
             AND t22.RESELLER_VERSION_ID = t2.RESELLER_VERSION_ID
       INNER JOIN
       DAY_TYPE_ID_VALUES t23
       ...
       INNER JOIN DAY_TYPE_ID_KEY t24 ON t2.SUNDAY_ID = t24.DAY_TYPE_ID
       INNER JOIN
       DAY_TYPE_ID_REF t25
          ON     t24.DAY_TYPE_ID = t25.DAY_TYPE_ID
             AND t25.RESELLER_VERSION_ID = t2.RESELLER_VERSION_ID
       INNER JOIN
       DAY_TYPE_ID_VALUES t26
