DROP VIEW CBS_OWNER.ZONE_VIEW;

/* Formatted on 22/05/2014 15:08:25 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.ZONE_VIEW
(
   ZONE_ID,
   LI,
   ZONE_NAME,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON CBS_OWNER.ZONE_VIEW TO VNP_COMMON;
