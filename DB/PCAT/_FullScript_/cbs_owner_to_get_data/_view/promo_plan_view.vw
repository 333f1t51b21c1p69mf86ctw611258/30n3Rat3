DROP VIEW CBS_OWNER.PROMO_PLAN_VIEW;

/* Formatted on 22/05/2014 15:08:19 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.PROMO_PLAN_VIEW
(
   OFFER_ID,
   OFFER_NAME,
   PROMO_PLAN_NAME,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON CBS_OWNER.PROMO_PLAN_VIEW TO VNP_COMMON;
