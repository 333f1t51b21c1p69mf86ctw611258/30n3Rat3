DROP VIEW CBS_OWNER.ZONE_GROUP_VIEW;

/* Formatted on 22/05/2014 15:08:24 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.ZONE_GROUP_VIEW
(
   GROUP_ID,
   GROUP_NAME,
   ZONE_A,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON CBS_OWNER.ZONE_GROUP_VIEW TO VNP_COMMON;
