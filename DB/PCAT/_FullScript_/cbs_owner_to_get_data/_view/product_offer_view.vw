DROP VIEW CBS_OWNER.PRODUCT_OFFER_VIEW;

/* Formatted on 22/05/2014 15:08:18 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.PRODUCT_OFFER_VIEW
(
   OFFER_ID,
   OFFER_NAME,
   OFFER_TYPE,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON CBS_OWNER.PRODUCT_OFFER_VIEW TO VNP_COMMON;
