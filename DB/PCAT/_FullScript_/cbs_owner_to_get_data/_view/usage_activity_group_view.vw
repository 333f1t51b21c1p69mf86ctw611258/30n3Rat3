DROP VIEW CBS_OWNER.USAGE_ACTIVITY_GROUP_VIEW;

/* Formatted on 22/05/2014 15:08:23 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.USAGE_ACTIVITY_GROUP_VIEW
(
   UA_MAP_ID,
   UA_GROUP_NAME,
   UA_GROUP_ID,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON CBS_OWNER.USAGE_ACTIVITY_GROUP_VIEW TO VNP_COMMON;
