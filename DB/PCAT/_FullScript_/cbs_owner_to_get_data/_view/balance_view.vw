DROP VIEW CBS_OWNER.BALANCE_VIEW;

/* Formatted on 22/05/2014 15:08:15 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.BALANCE_VIEW
(
   BALANCE_ID,
   RESELLER_VERSION_ID,
   UNIT_TYPE_NAME,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON CBS_OWNER.BALANCE_VIEW TO VNP_COMMON;
