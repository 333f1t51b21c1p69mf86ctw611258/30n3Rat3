DROP VIEW CBS_OWNER.TIME_MODEL_VIEW;

/* Formatted on 22/05/2014 15:08:22 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.TIME_MODEL_VIEW
(
   CALENDAR_ID,
   CALENDAR_NAME,
   MODEL_TYPE,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON CBS_OWNER.TIME_MODEL_VIEW TO VNP_COMMON;
