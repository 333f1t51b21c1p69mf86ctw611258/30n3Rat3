DROP VIEW CBS_OWNER.TIME_MAP_VIEW;

/* Formatted on 22/05/2014 15:08:21 (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW CBS_OWNER.TIME_MAP_VIEW
(
   CALENDAR_ID,
   RESELLER_VERSION_ID,
   CALENDAR_TYPE,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON CBS_OWNER.TIME_MAP_VIEW TO VNP_COMMON;
