/* Formatted on 3/22/2014 11:58:16 AM (QP5 v5.227.12220.39754) */
  SELECT t4.DISPLAY_VALUE AS balance_name,                      -- balanceKey,
    ...
    FROM OFFER_BALANCE_MAP t1
         INNER JOIN BALANCE_KEY t2 ON t1.BALANCE_ID = t2.BALANCE_ID
         INNER JOIN
         BALANCE_REF t3
         ...
         INNER JOIN OFFER_KEY t5 ON t1.OFFER_ID = t5.OFFER_ID
         INNER JOIN
         OFFER_REF t6
         ...
         LEFT OUTER JOIN OFFER_KEY t20 ON t1.ACCOUNT_OFFER_ID = t20.OFFER_ID
         LEFT OUTER JOIN
         OFFER_REF t21
         ...
         LEFT OUTER JOIN BALANCE_KEY t23
   ...
   WHERE t1.RESELLER_VERSION_ID = 2 AND t15.DISPLAY_VALUE = 'Postpaid'
