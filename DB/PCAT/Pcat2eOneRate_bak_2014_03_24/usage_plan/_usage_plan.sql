/* Formatted on 23/3/2014 11:17:28 (QP5 v5.215.12089.38647) */
SELECT t7.DISPLAY_VALUE AS usage_plan_name,                   -- usagePlanKey,
       ...
       t46.DISPLAY_VALUE AS usage_act_name,                    -- autFinalKey,
       t26.AUT_ID AS usage_act_id,                                   -- autId,
  ...
  FROM OFFER_USAGE_PLAN_MAP t1
       ...
       -- *** add usage plan item map
       INNER JOIN USAGE_PLAN_ITEM_MAP t21
