/* Formatted on 22/3/2014 23:58:35 (QP5 v5.215.12089.38647) */
SELECT t1.CURRENCY_CODE AS currency_code,
  ...
  FROM RATE_CURRENCY_KEY t1
       INNER JOIN RATE_CURRENCY_REF t2
          ON t1.CURRENCY_CODE = t2.CURRENCY_CODE
       INNER JOIN RATE_CURRENCY_VALUES t3
          ON     t2.CURRENCY_CODE = t3.CURRENCY_CODE
             AND t2.SERVICE_VERSION_ID = t3.SERVICE_VERSION_ID
       INNER JOIN CURRENCY_TYPE_REF t4
          ON t2.CURRENCY_TYPE = t4.CURRENCY_TYPE
       INNER JOIN CURRENCY_TYPE_VALUES t5
