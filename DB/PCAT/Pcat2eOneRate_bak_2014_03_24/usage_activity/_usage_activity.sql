/* Formatted on 23/3/2014 11:05:06 (QP5 v5.215.12089.38647) */
SELECT t1.AUT_TRANS_ID AS trans_id,                             -- autTransId,
       t8.DISPLAY_VALUE AS usage_act_name,                     -- autFinalKey,
       t2.FINAL_AUT_ID AS usage_act_id,                          --finalAutId,
  ...
  FROM AUT_TRANSLATION_KEY t1
       INNER JOIN AUT_TRANSLATION t2
          ON t1.AUT_TRANS_ID = t2.AUT_TRANS_ID
       INNER JOIN AUT_INITIAL_KEY t3
          ON t2.INITIAL_AUT_ID = t3.INITIAL_AUT_ID
       INNER JOIN AUT_INITIAL_REF t4
          ON     t3.INITIAL_AUT_ID = t4.INITIAL_AUT_ID
             AND t4.SERVICE_VERSION_ID = 1
       INNER JOIN AUT_INITIAL_VALUES t5
       ...
       LEFT OUTER JOIN AUT_TRANSLATION_SET t25
       ...
       LEFT OUTER JOIN AUT_TRANSLATION_SET t27
       ...
       LEFT OUTER JOIN AUT_TRANSLATION_SET t29
       ...
       LEFT OUTER JOIN AUT_TRANSLATION_SET t31
       ...
       LEFT OUTER JOIN AUT_TRANSLATION_SET t33
       ...
       LEFT OUTER JOIN AUT_TRANSLATION_SET t35
