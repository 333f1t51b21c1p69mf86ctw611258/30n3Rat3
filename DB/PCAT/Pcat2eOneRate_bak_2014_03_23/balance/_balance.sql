/* Formatted on 3/21/2014 8:35:13 PM (QP5 v5.227.12220.39754) */
SELECT t1.BALANCE_ID AS balance_id,                              -- balanceId,
  ...
  FROM BALANCE_KEY t1
       INNER JOIN BALANCE_REF t2 ON t1.BALANCE_ID = t2.BALANCE_ID
       INNER JOIN
       BALANCE_VALUES t3
