/* Formatted on 3/19/2014 11:12:35 PM (QP5 v5.227.12220.39754) */
SELECT t1.DAY_TIME_MAPPING_ID AS dayTimeMappingId,
  ...
  FROM DAY_TIME_MAPPING t1
       INNER JOIN TIME_SLOT_KEY t2 ON t1.TIME_SLOT_ID = t2.TIME_SLOT_ID
       INNER JOIN
       TIME_SLOT_REF t3
       ...
       INNER JOIN TIME_TYPE_KEY t5 ON t1.TIME_TYPE_ID = t5.TIME_TYPE_ID
       INNER JOIN
       TIME_TYPE_REF t6
       ...
       INNER JOIN DAY_TYPE_ID_KEY t8 ON t1.DAY_TYPE_ID = t8.DAY_TYPE_ID
       INNER JOIN
       DAY_TYPE_ID_REF t9
          ON     t8.DAY_TYPE_ID = t9.DAY_TYPE_ID
             AND t9.RESELLER_VERSION_ID = t1.RESELLER_VERSION_ID
       INNER JOIN
       DAY_TYPE_ID_VALUES t10
