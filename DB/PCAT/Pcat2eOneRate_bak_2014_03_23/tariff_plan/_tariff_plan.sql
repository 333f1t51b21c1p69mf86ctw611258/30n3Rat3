/* Formatted on 22/3/2014 22:33:23 (QP5 v5.215.12089.38647) */
SELECT t1.TARIFF_SET_MEMBER_ID AS tariff_set_member_id,  -- tariffSetMemberId,
  ...
  FROM TARIFF_PLAN_MAPPING t21
       ...
       LEFT OUTER JOIN RATE_CURRENCY_VALUES t28
