...
AS
   ...
   ******************************************************************************/
   ...
   IS
   BEGIN
      EXECUTE IMMEDIATE 'TRUNCATE TABLE ELC_USER.RESELLER_VERSION';
   ...
   IS
      ...
      IS
         SELECT *
          ...
          WHERE RV.STATUS = 3 OR RV.INACTIVE_DATE IS NOT NULL;
   ...
   BEGIN
      ...
      --
      ELC_USER.CBS_OWNER_FILTER.FILTER_BALANCE (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_CURRENCY_TYPE;

      ELC_USER.CBS_OWNER_FILTER.FILTER_DISCOUNT_MODEL (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_OFFER_BALANCE_MAP (
         I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_PRODUCT_OFFER (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_PROMO_MAP (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_RUM_MAP (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_TARIFF_MODEL (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_TARIFF_PLAN (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_TIME_MAP (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_TIME_MODEL (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_UNIT_TYPE;

      ELC_USER.CBS_OWNER_FILTER.FILTER_USAGE_ACTIVITY (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_USAGE_ACTIVITY_GROUP (
         I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_USAGE_PLAN (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_ZONE (I_RESELLER_VERSION_ID);

      ELC_USER.CBS_OWNER_FILTER.FILTER_ZONE_GROUP (I_RESELLER_VERSION_ID);
