/* Formatted on 04/03/2014 14:51:34 (QP5 v5.215.12089.38647) */
SELECT t1.CALENDAR_ID AS calendarId,
  ...
  FROM CALENDAR_KEY t1
       INNER JOIN CALENDAR_REF t2
          ON t1.CALENDAR_ID = t2.CALENDAR_ID
       INNER JOIN CALENDAR_VALUES t3
