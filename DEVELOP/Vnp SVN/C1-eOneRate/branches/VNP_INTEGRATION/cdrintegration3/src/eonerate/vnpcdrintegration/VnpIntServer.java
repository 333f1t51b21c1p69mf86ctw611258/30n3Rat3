package eonerate.vnpcdrintegration;
...
import eonerate.vnpcdrintegration.config.XmlRepo;
import eonerate.vnpcdrintegration.support.Constant;
import eonerate.vnpcdrintegration.support.FileUtil;
import eonerate.vnpcdrintegration.support.IntMonitor;
import eonerate.vnpcdrintegration.support.IntWorker;
import eonerate.vnpcdrintegration.support.RejectedExecutionHandlerImpl;

/**
 * Main class that can download files from an existing FTP server.
 */
public final class VnpIntServer {

	private VnpIntServer() {
	}
