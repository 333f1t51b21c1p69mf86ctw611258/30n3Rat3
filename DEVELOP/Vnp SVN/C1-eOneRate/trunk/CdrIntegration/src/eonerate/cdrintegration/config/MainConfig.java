...
public class MainConfig {
	...
	public String getExtFolderPath() {
		return extFolderPath;
	}

	public void setExtFolderPath(String extFolderPath) {
		this.extFolderPath = extFolderPath;
	}
	...
	public int getSlowerCdrInterval() {
		return slowerCdrInterval;
	}

	public void setSlowerCdrInterval(int slowerCdrInterval) {
		this.slowerCdrInterval = slowerCdrInterval;
	}
