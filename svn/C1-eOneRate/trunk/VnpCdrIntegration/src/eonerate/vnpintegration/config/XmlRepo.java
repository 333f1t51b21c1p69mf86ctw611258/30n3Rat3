package eonerate.vnpintegration.config;
...
public class XmlRepo {
	...
	public static MainConfig readMainConfig() {
		...
		//		String configFilePath = "config.xml"; // System.getProperty("user.dir") + "/vnpconfig/config.xml";

		String fileName = "config_vnpIntegration.xml";
